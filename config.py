...
data_arg.add_argument('--scaled', type=bool, default = False)
data_arg.add_argument('--std', type=bool, default = False)
...
train_arg.add_argument('--smote', type=bool, default = False)
...
train_arg.add_argument('--ae_epochs', type=int, default = 10)
